document.addEventListener('DOMContentLoaded', function() {
    ...
    axios.get('http://localhost/digital-wallet-platform/wallet-server/user/v1/get_verification_status.php', axiosConfig)
        .then(response => {
    ...
    if (balanceAmountElem) {
        axios.get('http://localhost/digital-wallet-platform/wallet-server/user/v1/get_balance.php', axiosConfig)
            .then(response => {
                if (response.data.error) {
    ...
    axios.get('http://localhost/digital-wallet-platform/wallet-server/user/v1/get_limits_usage.php', axiosConfig)
        .then(response => {
            if (response.data.error) {
